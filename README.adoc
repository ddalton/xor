...
We improve the performance for the Data retrieval use case by working with the UI model and for the Data generation use case by working with the JDBC model.
