/*
 * Copy of the original file due to version conflicts with other
 * Spring framework.
 * Specifically removing dependency to the hasText method.
 *
 * @author Dilip Dalton
 */
...
public abstract class ScriptUtils {
	 ...
	 * if the string not null, it's length is greater than 0, and
	 ...
	 * @return true if the String is not null, length is greater than 0,
	 ...
	 * @return true if there are delimiters
	 */
