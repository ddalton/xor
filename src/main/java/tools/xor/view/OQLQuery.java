...
public class OQLQuery {
	...
	public OQLQuery generateQuery(AggregateManager am, QueryView queryView) {
		QueryBuilder qb = am.getDAS().getQueryBuilder();
		qb.init(queryView.getAggregateType(), queryView, new LinkedList<Filter>());	
