...
@ContextConfiguration(locations = { "classpath:/spring-VO-custom-hibernate-test.xml" })
@TransactionConfiguration(defaultRollback = true)
@Transactional
public class HibernateQueryInheritanceCustomTest extends DefaultQueryInheritanceCustom {
