...
import tools.xor.logic.DefaultCheckType;

@ExtendWith(SpringExtension.class)
@ContextConfiguration(locations = { "classpath:/spring-jpa-test.xml" })
@Transactional
public class JPACheckTypeTest extends DefaultCheckType {
	...
	@Test
	public void checkReflectionGetter() {
		super.checkReflectionGetter();
	}
